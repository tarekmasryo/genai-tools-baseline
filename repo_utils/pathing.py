...
def resolve_data_path(
    ...
    *,
    ...
    Raises:
      FileNotFoundError with a clear message if not found.
    """
    ...
    if _is_kaggle():
        ...
        # Light search (avoid expensive rglob in huge trees)
        try:
            for p in base.glob("*/*"):
    ...
    raise FileNotFoundError(
        ...
        f"Tried: DATA_PATH env var, {local_subdir}/, and Kaggle /kaggle/input/.\n"
        "Tip: put the file under 'data/raw/' or set DATA_PATH."
    )
